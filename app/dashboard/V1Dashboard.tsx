/**
 * Dashboard do Membro v1 (legacy — modelo MLM com CV).
 *
 * @deprecated v1 — pivô V2 (28/04/2026) descontinuou o modelo CV. Esta tela é
 * renderizada apenas quando `isV2Enabled()` retorna false. Removida fisicamente
 * em F-V12. Ver docs/sdd/PIVOT-V2.md.
 *
 * Antes era `app/dashboard/page.tsx`. Em S1 (06/05/2026) movida para componente
 * pra permitir switch via flag em `app/dashboard/page.tsx` (Server Component).
 */
