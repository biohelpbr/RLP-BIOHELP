...
/**
 * @deprecated Painel de Resgates v1 (RPA/CPF + bank fields legacy).
 * Substituído por `V2AdminPayouts` quando flag LRP_V2=true.
 * Será removido na onda 6 / F-V12.
 */
...
export default function V1AdminPayouts() {
