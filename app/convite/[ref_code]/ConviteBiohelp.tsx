...
/**
 * Landing de convite do Nutrition Club (design v3, form.pdf oficial).
 * É o padrão: vale para TODOS os convites, exceto os códigos listados em
 * `creators_hub_links.ref_codes`, que usam o ConviteCreatorsHub.
 */
export function ConviteBiohelp({
  refCode,
  sponsorName,
}: {
  refCode: string
